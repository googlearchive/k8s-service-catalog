...
func templatesScControllerManagerDeploymentYamlTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/sc/controller-manager-deployment.yaml.tmpl", size: 2645, mode: os.FileMode(416), modTime: time.Unix(1507063620, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesGcpGoogleOauthDeploymentYamlTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/gcp/google-oauth-deployment.yaml.tmpl", size: 1914, mode: os.FileMode(416), modTime: time.Unix(1507063621, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
