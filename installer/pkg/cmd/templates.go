...
func templatesScApiserverDeploymentYamlTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/sc/apiserver-deployment.yaml.tmpl", size: 2733, mode: os.FileMode(416), modTime: time.Unix(1513721824, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesScControllerManagerDeploymentYamlTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/sc/controller-manager-deployment.yaml.tmpl", size: 2779, mode: os.FileMode(416), modTime: time.Unix(1513721824, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesScEtcdOperatorDeploymentYamlTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/sc/etcd-operator-deployment.yaml.tmpl", size: 587, mode: os.FileMode(416), modTime: time.Unix(1513721824, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
