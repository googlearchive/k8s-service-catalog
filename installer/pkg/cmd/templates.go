...
func templatesScApiserverDeploymentYamlTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/sc/apiserver-deployment.yaml.tmpl", size: 2732, mode: os.FileMode(420), modTime: time.Unix(1507322107, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesScControllerManagerDeploymentYamlTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/sc/controller-manager-deployment.yaml.tmpl", size: 2645, mode: os.FileMode(420), modTime: time.Unix(1507322107, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
